...
_SERVICE_CONTAINER = _descriptor.Descriptor(
  ...
  nested_types=[_SERVICE_CONTAINER_ENVIROMENTVARIABLESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
