...
_BUFFER_HEAD_PARTITION_INDEXENTRY = _descriptor.Descriptor(
  name='IndexEntry',
  full_name='api.Buffer.Head.Partition.IndexEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='api.Buffer.Head.Partition.IndexEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='api.Buffer.Head.Partition.IndexEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUFFER_HEAD_PARTITION = _descriptor.Descriptor(
  name='Partition',
  full_name='api.Buffer.Head.Partition',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='index', full_name='api.Buffer.Head.Partition.index', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUFFER_HEAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='index', full_name='api.Buffer.Head.index', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partitions', full_name='api.Buffer.Head.partitions', index=1,
...
_BUFFER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='signal', full_name='api.Buffer.signal', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='head', full_name='api.Buffer.head', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_chunk', full_name='api.Buffer._chunk',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_separator', full_name='api.Buffer._separator',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_signal', full_name='api.Buffer._signal',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_head', full_name='api.Buffer._head',
  ...
  'Head' : _reflection.GeneratedProtocolMessageType('Head', (_message.Message,), {
    ...
    'Partition' : _reflection.GeneratedProtocolMessageType('Partition', (_message.Message,), {
      ...
      'IndexEntry' : _reflection.GeneratedProtocolMessageType('IndexEntry', (_message.Message,), {
        ...
        '__module__' : 'api_pb2'
        # @@protoc_insertion_point(class_scope:api.Buffer.Head.Partition.IndexEntry)
        })
      ,
      'DESCRIPTOR' : _BUFFER_HEAD_PARTITION,
      '__module__' : 'api_pb2'
      # @@protoc_insertion_point(class_scope:api.Buffer.Head.Partition)
      })
    ,
    'DESCRIPTOR' : _BUFFER_HEAD,
    '__module__' : 'api_pb2'
    # @@protoc_insertion_point(class_scope:api.Buffer.Head)
    })
  ,
  'DESCRIPTOR' : _BUFFER,
  '__module__' : 'api_pb2'
